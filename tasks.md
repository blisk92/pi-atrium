...
- [ ] **Task 2.1 — "Define team"** — User creates a team via form, saved to vault, shows in sidebar as Draft
...
- [ ] **Task 2.2 — "Team runs"** — User clicks Start, members spawn, status goes Draft → Active
...
- [ ] **Task 2.3 — "Halt team"** — User clicks Halt, graceful shutdown with 10s brain-save window
